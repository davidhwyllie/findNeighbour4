...
if __name__ == '__main__':
    ...
    def monitor(report_type = 'Report' ):
        ...
        if html is None:
            html = "No report of type {0} is available.  Reports are generated by a separate process, findNeighbour4_monitor.py, which may not be running.".format(report_type)
        return html
