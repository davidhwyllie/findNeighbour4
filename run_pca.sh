...
# run R analysis
cd pca
Rscript plot_strain_emergence.R --searchdir /data/data/pca/realtime_400/ --filepattern ${analysis_name}.sqlite --highlight_min_estimate_IRR 1 --highlight_max_samples 5000 -r 0 -i 30 -a 2021-03-01
