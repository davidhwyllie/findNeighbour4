...
class fn3persistence:
    ...
    *max_neighbours_per_document* should be less than 5,000, because there is a max. document size in mongodb.
    ...
    def delete_server_monitoring_entries(self, before_seconds):
        ...
        -- cleanup function is still required """
    ...
    def summarise_stored_items(self):
        ...
        -- this is a database size reporting function
        -- it can be ignored initially, and just return an empty dictionary """
        retVal = {}
    ...
    def connect(self):
        ...
        -- this is probably unnecessary with an RDBMS, to review and discuss with Oracle staff """
    ...
    def _connect(self):
        ...
        -- alternative code has been provided in rdbmsstore.py, see there."""
    ...
    def is_connected(self):
        ...
        -- this is probably unnecessary as a function.  it's only used internal to this module"""
        try:
    ...
    def rotate_log(self):
        ...
        -- not necessary with Oracle ADW.  is called from external,  Retain as a function which does nothing"""
    ...
    def _delete_existing_data(self):
        ...
        -- review whether this is necessary - I think it is is not now.  Dropping tables and recreating is a faster and better method"""
    ...
    def recent_database_monitoring(self, max_reported=100):
        ...
        -- it is important that storage ratio is returned as 1
        -- return dict(latest_stats = dict(storage_ratio = 1)) ## not tested"""
    ...
    def recent_server_monitoring(self, max_reported=100, selection_field=None, selection_string=None):
        ...
        -- this is used for server health monitoring.  It would be good if this was maintained
    ...
    def guid_annotate(self, guid, nameSpace, annotDict):
        ...
        -- simple to replace
        -- we have a field in the RefCompressedSequence update here which can be updated/added
        --  note that the invalid key and prop_actg are write once and can't be changed on insertion
        """
    ...
    def guids(self):
        ...
        -- simple to replace; returns the sample_id field from the RefCompressedSequence table. """
    ...
    def singletons(self, method="approximate", return_top=1000):
        ...
        -- this function is complicated but will no longer be required as it is related to repacking and AFAIK is not called externally (need to check)
        """
    ...
    def guid_examination_time(self, guid):
        ...
        -- note that this is now in a field in RefCompressedSequence
        """
    ...
    def guid2items(self, guidList, namespaces):
        """returns all annotations in namespaces, which is a list, as a dictionary.
    ...
    def guid2neighbour_add_links(self, guid, targetguids, use_update=False):
        ...
        The number of records written
                 ...
                 -- ** must ** use the _bulk_upload method, otherwise it's far to slow
    ...
    def _audit_storage(self, guid):
        ...
        -- not sure what to do here, need to think about htis.  Suspect it's not needed at all
        """
    ...
    def guid2neighbour_repack(self, guid, always_optimise=False, min_optimisable_size=1):
        ...
        -- not needed in the new implementation,  but retain as a stub, which returns something compatible likr
        return {
                    "guid": guid,
    ...
    def guid2neighbours(self, guid, cutoff=20, returned_format=2):
        ...
        format 4 [{'guid':otherguid, 'snv':distance}]
            ...
            -- easy to replace using a simple SQL query
            4
        """
