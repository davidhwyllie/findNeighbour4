...
def createPersistence(
    """ example function which returns either an rdbms or mongo persistence object """
    connString: str,
    ...
    if connection_config := os.environ.get("FINDNEIGHBOUR_USE_RDBMS"):
        return rdbmsstore.findNeighbour4(
            connection_config, debug, server_monitoring_min_interval_msec
        )
    else:
        return mongoStore.findNeighbour4(
            connString,
            dbname,
            debug,
            config_settings,
