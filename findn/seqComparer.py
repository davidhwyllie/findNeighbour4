...
class seqComparer:
    def __init__(self, reference, maxNs, snpCeiling, excludePositions=set(), return_none_if_high_snp_distance=True):
    ...
    def mcompare(self, guid, guids=None):
        ...
        for key2 in guids:
            if not guid == key2:
                (guid1, guid2, dist, n1, n2, nboth, N1pos, N2pos, Nbothpos) = self.countDifferences_byKey(
