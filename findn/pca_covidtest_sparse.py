...
class VariationModel():
    ...
    def cluster(self, eps=0.5, drop_first_pcs=0, build_tree=True):
        ...
        Inputs:
            ...
            drop_first_pcs:  omit the first pcs (up to this number) from the alignment.  Set to None or 0 to drop none.
...
""")
    ...
    if rebuild:
        ...
        vm = builder.build(train_on=None, n_components=100, pca_parameters= {'n_jobs':-1})       # run all   
