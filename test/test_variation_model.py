...
class TestGetPositionCounts(TestCase):
    ...
    def test_one_guid_correct_counts(self):
        ...
        analysed_samples, vmodel, mmodel = SNPMatrix.get_position_counts({"s1"}, 100, PERSIST_object)
    ...
    def test_two_guid_correct_counts(self):
        ...
        analysed_samples, vmodel, mmodel = SNPMatrix.get_position_counts(["s1", "s2"], 100, PERSIST_object)
...
class TestGetMissingness(TestCase):
    def test_get_missingness_cutoff(self):
        ...
        cutoff = SNPMatrix.get_missingness_cutoff(selected_positions, mmodel)
    ...
    def test_remove_positions_with_high_missingness(self):
        ...
        cutoff = 6
        num_removed = SNPMatrix.remove_high_missingness_positions(selected_positions, mmodel, cutoff)
