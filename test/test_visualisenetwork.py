...
class test_nv_to_dict(unittest.TestCase):
    ...
    def runTest(self):
        ...
        d = nv.to_dict()
        self.assertTrue(d["directed"] is False)
...
class test_add_guids_2(unittest.TestCase):
    ...
    def runTest(self):
        ...
        neighbours = [
            ["68f914ea-b2b0-493a-ba56-155235dcec30", 17],
            ["29a7737f-2298-4e57-bb0e-8678c84bedd8", 13],
            ["17922571-c82f-440f-bda4-3ebfb20fa554", 10],
        ]
