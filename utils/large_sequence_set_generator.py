...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="""Produces a simulated sequences, with ancestors and their descendents,
...
"""
    ...
    parser.add_argument(
        "n_sequences", type=int, nargs=1, help="number of ancestors sequences to simulate. Suitable value = 10"
    )
    parser.add_argument(
        "k1",
        type=int,
    ...
    parser.add_argument(
        "s", type=int, nargs=1, help="the mean number of SNV by which children differ from their parent.  Suitable value = 2"
    )
    parser.add_argument(
        "max_c",
        type=int,
