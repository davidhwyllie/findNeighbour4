""" dumps reference compressed sequences to a tar archive which can be used by a 
fake 'PERSIST' object

Mainly useful for making data sets for unit testing and for 
producing frozen test sets for performance characterisation.
...
from manipulate_tree import ManipulateTree
