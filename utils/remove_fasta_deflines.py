...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="""Produce gzipped fasta files with sanitised deflines
inputdir    inputdirectory in which .fasta files are sought
outputdir   output directory into which .fasta files are written.
"""
    )
    parser.add_argument("inputdir", type=str, nargs=1, help="Input directory")
    parser.add_argument("outputdir", type=str, nargs=1, help="Output directory")
