...
if __name__ == '__main__':
    ...
    print("The following items failed a compositional (MIXPORE) test with more Ns/Ms than expected in the alignment; their positions in the ML tree are likely unstable")
