...
# this code discovers two pairs which are not stored as having neighbours
# although the hybridcomparer vs seqcomparer test (findneighbour4-server-integration-test) does not detect a problem.
