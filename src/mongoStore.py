...
class fn3persistence():
        ...
        -'refcompressedseq' contains reference compressed sequences. note that this is a gridfs 'filesystem' and the keys
        are not the guids, but internal _ids generated by gridfs.  These internal ids are stored as 'refcompseq_id' in guid2meta.
        ...
        def guid2neighbours(self, guid, cutoff =20, returned_format=2):
                """ returns neighbours of guid with cutoff <=cutoff.
                    ...
                    or as format 2 [otherGuid, distance, N_just1, N_just2, N_either
                        ...
                        """                
                retVal=[]
                formatting = {1:['dist'], 2:['dist','N_just1','N_just2','N_either']}
