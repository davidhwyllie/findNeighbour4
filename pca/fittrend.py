#!/usr/bin/env python
""" 
fits statistical models to count data
...
class ModelCounts:
    """fits negative binomial and Poission models to count data, where each pc_cat is represented"""
    ...
    def __init__(
        ...
        Suitable input can be generated by the  PCADatabaseManager.pcas_count_table(format = 1 ) method
    ...
    def fit_nb(self, raise_error_for_unittest=False):
        ...
        try:  # debug disabled
            ...
            coeff_df["comments"] = "Neg binomial regression on a subset of data"
            coeff_df["param_desc"] = "-"
            coeff_df.at[
                "t", "param_desc"
